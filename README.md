...
아래의 표는 현재 업로드된 KESS-V1.0에 포함된 분석방법을 정리한 것으로 각 분석 메뉴의 버전은 KESS 메뉴 중 "KESS 버전 확인"을 통해 확인할 수 있습니다. 본인 컴퓨터에 설치된 버전과 최신 버전이 다른 경우 최신 버전으로 업데이트하세요. 참고로 현재 “KESS.xlam"의 버전은 1.24.05이며 2024년 12월까지 사용가능합니다. 주기적 업데이트를 위해 매년 사용기한을 연장합니다.
